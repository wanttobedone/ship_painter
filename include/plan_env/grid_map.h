...
public:
  ...
  void publishMapInflateMarker(bool all_info = false);
...
private:
  ...
  ros::Subscriber indep_cloud_sub_, indep_odom_sub_, indep_depth_sub_;
  ros::Publisher map_pub_, map_inf_pub_;
  ros::Publisher map_marker_pub_, map_inf_marker_pub_;
